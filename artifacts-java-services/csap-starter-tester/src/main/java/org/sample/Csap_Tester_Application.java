...
import org.sample.input.http.jersey.*;
...
//	}
    ...
    public Csap_Tester_Application( ) {

        logger.warn( CsapApplication.arrowMessage( "Loading Configuration" ) );
...
//		metricUtilities.addCsapCollectionTag( "x-dbcp.*connection" ) ;
    ...
    public void addMetersToCsapRegistry( ) {

        logger.warn( CsapApplication.arrowMessage( "Update tags" ) );
        metricUtilities.addCsapCollectionTag( "x-dbcp.*connection" );
...
//		} ) ;
    ...
    public static class MyCustomSecurityPolicy implements CsapSecurityConfiguration.CustomHttpSecurity {
        ...
        public void configure(
            ...
            LoggerFactory
                    .getLogger( Csap_Tester_Application.class )
            ...
            httpSecurity
                    ...
                    .authorizeHttpRequests( ( requests ) -> requests
                            .requestMatchers(
                                    bootActuatorContext + "/prometheus",
                                    SPRINGREST_URL + LARGE_PARAM_URL + "/**",
                                    "/jersey/**",
                                    "/spring-rest/db/statistics"
                            ).permitAll( )
...
//					+ "\n\n" );
    ...
    @Bean
    public SqlDataSourceScriptDatabaseInitializer stubDbInit( ) {
        return null;
    }
    ...
    public BasicDataSource helloDataSource( ) {
        ...
        logger.debug( CsapApplication.header( "Building datasource" ) );

        var helloDataSource = new BasicDataSource( );
