...
public abstract class CsapBareTest {
	...
	public @interface ActiveProfiles_JunitDb {
	}
	...
	void thinBeforeAll ( )
		...
		logger.info( CsapApplication.smallTestHeader( "initializing {}" ), this.getClass( ).getSimpleName( ) ) ;
...
//		application.setAgentRunHome( System.getProperty( "user.home" ) + "/target" ) ;
