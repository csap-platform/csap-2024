...
class EclipseJGitTests {
	...
	String baseLocation = CsapApplication.BUILD_FOLDER_NAME + "/agentUnitTests/junit-" + this.getClass( ).getSimpleName( ) + "/" ;

//	String SAMPLE_GIT = "https://github.com/csap-platform/csap-packages" ;
	String SAMPLE_GIT = "https://github.com/csap-platform/csap-core" ;

	String SAMPLE_GIT_BRANCH = "refs/heads/master" ;

	@Test
	@Tag ( "containers" )
	public void anonymous_checkout_from_github ( )
		throws Exception {
...
//						new UsernamePasswordCredentialsProvider( "dummy", "dummy" ) )
	...
	@Test
	@Tag ( "containers" )
	public void anonymous_checkout_from_github_with_branch ( )
		throws Exception {
