...
public class KubernetesCsapTests extends CsapThinNoProfile {
	...
	class Stateless {
		...
		public void is_pod_running ( ) throws Exception {
			...
			var calico = ProjectLoader.getDefaultService( services, "calico-node", getJsonMapper( ) ) ;
			...
			var noServiceName = ProjectLoader.getDefaultService( services, "no-service-name", getJsonMapper( ) ) ;
...
//					.isEqualToIgnoringCase( "Success" ) ;
	...
	private ServiceInstance build_service_from_definition (
		...
		serviceInstance.setHostName( "centos1.na.demo-xxx.net" ) ;
