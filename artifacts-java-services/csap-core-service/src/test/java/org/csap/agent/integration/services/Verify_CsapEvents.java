...
class Verify_CsapEvents {
	...
	static {
		...
		CsapApplication.initialize( "Test Setup Complete2" ) ;
	...
	class EventDisabled {
		...
		public void beforeAll ( )
			...
			assertThat( csapApplication.load_junit_definition_start_collectors( false, publishDisabledDefinition ) ).as(
	...
	class EventEnabled {
		...
		public void beforeAll ( )
			...
			assertThat( csapApplication.load_junit_definition_start_collectors( false, configFile ) )
					.isTrue( )
