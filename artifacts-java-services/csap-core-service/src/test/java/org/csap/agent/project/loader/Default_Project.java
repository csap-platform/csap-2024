...
public class Default_Project extends CsapBareTest {
	...
	@Test
	public void copySource_service_loaded ( )
		throws Exception {

		logger.info( CsapApplication.testHeader( ) ) ;


		var verify2Service = getApplication( ).findServiceByNameOnCurrentHost( "csap-verify-service-2" ) ;
		
		logger.info( "loaded: {}", verify2Service.toSummaryString( ) );
		

		assertThat( verify2Service ).isNotNull( ) ;
		
		assertThat( verify2Service.getPort( ) ).isEqualTo( "7015" ) ;
		

		logger.info( "loaded: {}", verify2Service.details( ) );
