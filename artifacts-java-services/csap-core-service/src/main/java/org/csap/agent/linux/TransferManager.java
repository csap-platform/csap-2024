...
public class TransferManager {
    ...
    public void httpCopyViaCsAgent(
        ...
        logger.info( CSAP.buildDescription( "running file stat (slow fs intermittent failures)",
                "sourceLocation", "exists: " + sourceLocation.exists( ) + " " + sourceLocation,
                "zipLocation", "exists: " + zipLocation.exists( ) + " " + zipLocation
        ) );
