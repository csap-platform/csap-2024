...
//	@Autowired ( required = false )
	FileApiUtils fileApiUtils = null ;
	...
	public CsapSecuritySettings security ( ) {

		return csapApplication.getSecuritySettings( ) ;
	...
	public FileApiUtils fileUtils( ) {
		return fileApiUtils;
	}

	public void setFileApiUtils( FileApiUtils fileApiUtils ) {
