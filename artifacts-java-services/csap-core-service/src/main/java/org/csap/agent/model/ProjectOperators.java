...
public class ProjectOperators {
    ...
    public ObjectNode processAutoPlay(
            File autoplayFile,
            File projectFile,
    ...
    public ObjectNode performCreateOperation(
            File createFile,
            ObjectNode autoPlay
    ) {
    ...
    public List<ObjectNode> loadYaml(
            File yamlFile,
            ObjectNode results
    ) {
        ...
        if ( !yamlFile.canRead( ) ) {
            logger.warn( "requested file is not readable: {} ", yamlFile );
        }

        try {

            var yamlParser = yaml.createParser( yamlFile );
    ...
    public ObjectNode performModifyOperations(
            ObjectNode modifyOperations,
            ObjectNode projectDefinition
    ) {
    ...
    public ObjectNode updateClusterHosts(
            JsonNode clusterToHosts,
    ...
    public JsonNode mapIndexedHosts(
            JsonNode hosts,
            JsonNode baseOsHosts,
            String clusterName
    ) {
    ...
    public ObjectNode processDeletes(
            JsonNode deletes,
            ObjectNode projectDefinition
    ) {
    ...
    public void buildMissingPaths(
            JsonNode deletes,
            ObjectNode projectDefinition,
            ArrayNode deleteMissingResults
    ) {
    ...
    public ObjectNode processInserts(
            JsonNode inserts,
            ObjectNode projectDefinition
    ) {
    ...
    public ObjectNode processUpdates(
            JsonNode updates,
            ObjectNode projectDefinition
    ) {
    ...
    public ObjectNode removeEnvironments(
            ObjectNode environments,
            String activeName
    ) {
    ...
    public boolean envContainsImport(
