...
public class ServiceMeter {
	...
	private Pattern regexPatternForCollector ;
	...
	public boolean isHttp ( ) {
		...
		return meterType.isHttp( ) ;

	}

	public boolean isMbean ( ) {

		return meterType.isMbean( ) ;
	...
	public Pattern getRegexPatternForCollector ( ) {

		return regexPatternForCollector ;

	}

	public void setRegexPatternForCollector ( Pattern regexPatternForCollector ) {

		this.regexPatternForCollector = regexPatternForCollector ;
	...
	@JsonIgnore
	public String getMbeanCollectAttributeName ( ) {

		if ( StringUtils.isEmpty( mbeanAttribute ) )
			return mbeanAttribute ;

		var attributeName_optionalSubName = mbeanAttribute.split( ",," ) ;

		return attributeName_optionalSubName[0] ;

	}

	@JsonIgnore
	public String getMbeanCollectSubAttributeName ( ) {
		...
		if ( attributeName_optionalSubName.length == 1 ) {

			return null ;

		}

		return attributeName_optionalSubName[1] ;
