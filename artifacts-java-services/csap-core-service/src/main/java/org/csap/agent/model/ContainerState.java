...
public class ContainerState {
	...
	private long rssMemory = 0 ;
	private long pssMemory = 0 ;
	private long virtualMemory = 0 ;
	...
	public void setRssMemory ( long rssMemory ) {
	...
	public void addRssMemory ( String rssMemory ) {
		...
		try {
			...
			var val = Long.parseLong( rssMemory ) ;
			this.rssMemory += val ;
	...
	public void addVirtualMemory ( String virtualMemory ) {
		...
		try {
			...
			var val = Long.parseLong( virtualMemory ) ;
	...
	public long getRssMemoryInKb ( ) {

		return rssMemory ;

	}

	@JsonProperty ( OsProcessEnum.PSS_MEMORY )
...
//	public void addPssMemory ( long pssMemory ) {
//
//		if ( pssMemory > 0 ) {
//
//			logger.info( "Adding {}", pssMemory ) ;
//
//		}
//
...
//	}
	...
	public void setPssMemory ( long pssMemory ) {
	...
	@JsonProperty ( JavaCollectionAttributes.TOMCAT_CONNECTIONS )
	...
	@JsonProperty ( JavaCollectionAttributes.JVM_THREAD_COUNT )
