...
//			client.getHttpClient( ).
		...
		try {
			...
			// Customize timeouts
			var httpClientclientBuilder = kubernetesApiPooledClient.getHttpClient( ).newBuilder( )
			...
			if ( ! CsapApplication.isCsapFolderSet() ) {
				logger.warn( "Running on desktop: disabling hostNameVerified for aws" );
			...
			kubernetesApiPooledClient.setHttpClient( httpClientclientBuilder.build() ) ;
