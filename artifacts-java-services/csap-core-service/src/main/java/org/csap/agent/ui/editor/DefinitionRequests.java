...
public class DefinitionRequests {
	...
	public ObjectNode settingsConfig (
		...
		try {
			...
			performanceCollections.set( "Java", JavaCollectionAttributes.graphLabels( ) ) ;
	...
	synchronized public ObjectNode validateDefinition (
		...
		results.put( "summaryMessage", csapApis.application( ).getProjectLoader().getLastSummary() ) ;
	...
	synchronized public ObjectNode //
		...
		resultReport.put( C7.response_plain_text.val( ), outputManager.getContents( ) ) ;
		resultReport.put( "summaryMessage", csapApis.application( ).getProjectLoader().getLastSummary() ) ;
	...
	synchronized public ObjectNode application_reload (
		...
		resultJson.put( "summaryMessage", csapApis.application( ).getProjectLoader().getLastSummary() ) ;
