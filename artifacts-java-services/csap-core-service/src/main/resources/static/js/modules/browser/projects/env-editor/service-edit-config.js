...
function service_config() {
    ...
    var helpValues = {
        ...
        "nodeSelector": {
            "kubernetes.io/hostname": "YOURHOST.csap.org"
        },
            ...
            "scripts": [
                {
					...
					"parameters": [
                        "Summary,__Short Details,-- line 1 notes. -- line 2 notes -- line 3 notes -- line 4 link: <a href='https://github.com/csap-platform/csap-core/wiki'>csap manual</a>",
        ...
        "scripts": [
            {
                ...
                "frequency": "onDemand",
                "script": "$CSAP_FOLDER/bin/checkLimits.sh"
            },
            {
                "description": "run script after deploy",
                "frequency": "event-post-deploy",
                "script": "$csapResourceFolder/common/deploy-events.sh"
            },
            {
