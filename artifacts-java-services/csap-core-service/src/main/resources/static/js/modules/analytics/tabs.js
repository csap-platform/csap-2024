...
function perfomance_tabs() {
    ...
    function registerForTabActivates() {
        $( "#reportTabs" ).tabs( {
            activate: function ( event, ui ) {
                ...
                console.log( `activating tab:`, ui.newTab ) ;
                ...
                if ( ui.newTab.data( "report" ) != undefined ) {
                    ...
                    if ( uiSettings.reportRequest && 
                        (uiSettings.reportRequest.indexOf( METRICS_JAVA ) == 0
                    ...
                    } else if ( uiSettings.reportRequest && uiSettings.reportRequest.indexOf( "os-process" ) == 0 ) {
    ...
    function buildGraphObject( containerId, metricType ) {
        ...
        theNewGraph.addCustomViews();

        $.when( theNewGraph.getGraphLoadedDeferred() ).done( function () {
            theNewGraph.addCustomViews();
        } );
    ...
    function activateTab( tabId ) {
        ...
        console.trace("showing stack for tab activate");
    ...
    function showGraphTab( metric ) {
        ...
        if ( metric == METRICS_JAVA ) {
            ...
            if ( jmxGraph == null ) {
                ...
                isGraphRefreshed = true;
                console.log( ` checking: uiSettings.appGraphParam `, uiSettings ) ;
                if ( uiSettings.appGraphParam  ) {
                    //$.when( jmxGraph.getGraphLoadedDeferred() ).done( function () {
    ...
    function checkForApplication( selectedJmx_JQ ) {
        ...
        let serviceName = selectedJmx_JQ.data( "servicename" );
