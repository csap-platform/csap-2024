...
function os_app_graphs() {
    ...
    function setupAndShow( $launchButton, serviceName ) {
        ...
        let navTabWidth = utils.findNavigation( "#tabs" ).outerWidth( true ) ;
        let navBarWidth = utils.findNavigation( "#bar" ).outerWidth( true ) ;
        let navWidth = navBarWidth ;
        if ( navBarWidth > navTabWidth ) {
            navWidth = navBarWidth ;
        }
