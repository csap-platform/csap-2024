...
function utils_loader() {
    ...
    let jsonForms = {
        ...
        runUpdateFunction: function () {
            console.log( "runUpdateFunction() " );

            _dom.csapDebug( `_updateGlobalDefinitionFunction`, _updateGlobalDefinitionFunction );
    ...
    function loadValues( dialogId, definitionJson, defaultValues ) {
        ...
        $( dialogId + ' [data-path]' ).each( function () {
            ...
            if ( dataValue != undefined
                ...
                console.debug( "Defaults: key", jsonKey );
                _dom.csapDebug( `foundValues`, foundValues );
        ...
        console.log( "Service does not contain the following elements" );

        _dom.csapDebug( `undefinedAttributes`, undefinedAttributes );
        console.groupEnd();
    }
    ...
    function getJsonText( $textArea, isFormatYaml = false ) {
        ...
        if ( isConvertYaml( $textArea ) && !isJsonMode ) {
            ...
            _dom.csapDebug( `originalSource`, originalSource );
        ...
        aceTextEditor.getSession().on( 'change', function () {
            ...
            _jsonParseTimer = setTimeout( function () {
                ...
                if ( aceEditorId.startsWith( "propFileText-ace" ) ) {
                    let propertyFileName = $( "#serviceEditor #propFileName" ).val();
