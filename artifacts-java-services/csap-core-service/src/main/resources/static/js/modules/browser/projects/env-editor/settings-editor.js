...
function settings_editor() {
    ...
    let _defaultValues = {
        ...
        "application": {
            ...
            "help-menu": {
                "Local Login": "http://$$service-fqdn-host:8011/login?local=true",
            ...
            "custom-properties": [
                ...
                {
                    "name": "path-for-application",
                    "value": "/path/to/some/resources"
                },
                {
                    "name": "universal-password",
                    "key": "property.key.in-file",
                    "file": "$$path-for-application/$$service-name/demo-catalina.properties"
                }
            ]
        },
