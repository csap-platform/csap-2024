...
function performance_app() {
    ...
    const $main = $( "#analytics-portal" ) ;

    const $header = $( "header", $main ) ;

    const $globalDate = $("#global-graph-date input", $header) ;
    ...
    this.initialize = function () {
        ...
        utils.setGlobalDate( $globalDate ) ;
        ...
        console.log( `Processing uiSettings:`, uiSettings );
            ...
            if ( uiSettings.reportRequest ) {
                if ( uiSettings.reportRequest == "tableHost" ) {
                    ...
                    if ( uiSettings.reportRequest.indexOf( "graph" ) == 0 ) {
                        ...
                        console.log( ` Waiting for model loaded - then switching to service tab` );
