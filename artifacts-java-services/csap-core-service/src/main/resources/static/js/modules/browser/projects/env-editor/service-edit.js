...
//            $( ".osOptions" ).show();
        ...
        } else if ( serverType.includes( "csap-api" )
                || serverType.includes( "os" )
                || serverType.includes( "docker" ) ) {
...
//                    $( ".use-deployment-file-panel" ).fadeTo( 500, 1.0 );
            ...
            if ( serverType.includes( "csap-api" ) ) {
...
//            $( ".osOptions" ).hide();
        ...
        if ( serverType.includes( "docker" ) || serverType.includes( "os" ) ) {
//            $( ".deployTab" ).hide() ;
            if ( serverType.includes( "docker" ) ) {
