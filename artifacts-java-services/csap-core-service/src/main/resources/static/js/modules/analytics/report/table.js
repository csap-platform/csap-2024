...
function table_main() {
    ...
    function buildTable( responseJson, reportId, tableId ) {
        ...
        if ( dataService.isCompareSelected() ) {
            ...
            message += '<span style="padding-left: 3em">Minimum Value Filter: <label>'
                + $( "#compareMinimum" ).val();
        ...
        setTimeout( function () {
            ...
            if ( !metricParamDoneOnce && $.urlParam( "metric" ) != null ) {
                ...
                setTimeout( function () {
                    ...
                    let metricParameter = $.urlParam( "metric" ) ;
                    console.log(`metricParameter: ${ metricParameter }`) ;
                    $( "#visualizeSelect" ).val( metricParameter.replaceAll("__", ",") );
    ...
    function buildUseridRow( responseJson, tableRow, rowJson ) {
        ...
        if ( theUser.includes( "system" ) || theUser.includes( ".gen" ) || theUser.includes( "agentuser" ) || theUser.includes( "null" ) || theUser.includes( "csagent" ) ) {
