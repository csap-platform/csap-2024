    ...
    function init() {
        ...
        if ( _needsInit ) {
            ...
            $( '#osProcessAnalytics' ).click( function () {
                ...
                utils.launch( utils.updateUrlIfDesktop( urlAction ))  ;
            } ) ;
...
//		if ( graphId.includes( "rssMemory" ) || graphId.includes( "diskUtil" ) )
//			graphId += "InMB";
//
//		if ( graphId.includes( "topCpu" ) )
//			graphId = "Cpu_15s";
    ...
    function mergeArrayValues( inputArray ) {
        ...
        if ( ! inputArray ) {
            console.log( `generating stub data`) ;
            inputArray = [ -1,-1,-1] ;
        }
