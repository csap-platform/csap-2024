...
public class Csap_Simple_Application implements WebMvcConfigurer {
    ...
    public void addResourceHandlers( ResourceHandlerRegistry registry ) {
        ...
        logger.info( "Web caching enabled, productionCaching: {}", productionCaching );
        logger.info( CsapApplication.testHeader( "3" ) );
...
//		} ) ;
    ...
    public static class MyCustomSecurityPolicy implements CsapSecurityConfiguration.CustomHttpSecurity {
        ...
        public void configure(
            ...
            LoggerFactory
                    .getLogger( Csap_Simple_Application.class )
            ...
            httpSecurity
                    ...
                    .authorizeHttpRequests( ( requests ) -> requests
                            .requestMatchers(
                                    "/cors/currentTime", "/helloNoSecurity", HelloService.HELLO_WITH_REST_ACL
                            ).permitAll( )
