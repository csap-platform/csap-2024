...
public class Csap_Api_Tests {
	...
	public void verify_micrometers_escaped_slashes ( )
		...
		var location = "/http.server.requests[_csapHiNoSecurity]/count" ;
//		var location = "/http.server.requests[error=none,exception=none,_csapHiNoSecurity]/count" ;
		assertThat(
	...
	public void verify_micrometers_http_filter ( )
		...
		var tcStart = meterReport.buildSimple( null, List.of( "/csapHiNoSecurity" ), 3, false ) ;

		hit_test_url( ) ;
		hit_test_url( ) ;
		hit_test_url( "/demo2" ) ;

		var allMetrics = meterReport.buildSimple( null, null, 3, false ) ;
		...
		var filteredTagMetrics = meterReport.buildSimple( null, List.of( "/csapHiNoSecurity" ), 3, false ) ;
...
//		assertThat( numMetrics ).isEqualTo( 3 ) ;
		assertThat( numMetrics ).isEqualTo( 4 ) ;
