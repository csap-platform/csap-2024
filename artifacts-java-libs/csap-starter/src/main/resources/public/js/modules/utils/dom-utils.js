...
DomUtils.logHead = function ( msg ) {
    ...
    return console.log.bind( window.console, `%c--------> %s`, "color: green; font-size: 10pt;" );
}();

DomUtils.logHead( `loaded` );
...
DomUtils.csapDebug = function ( msg, object ) {

    console.debug(`${msg} %c set window.csapdebug=true to view`, "color: grey; font-size: 8pt;" ) ;
    if ( !window.csapdebug || !window.console || !console.log ) {
        return;
    }
    console.log( `===== Object Dumps cause Memory Leaks =====\n ${ msg }\n`, object );
};
...
DomUtils.logError = function ( msg ) {
    ...
    return console.error.bind( window.console, `%c\n*\n**\n*** %s \n**\n*`, "color: red; font-size: 12pt;" );
}();
...
DomUtils.logSection = function ( msg ) {
    ...
    // return Function.prototype.bind.call(console.log, "prefix");
    return console.log.bind( window.console, `%c\n*\n**\n*** %s \n**\n*`, "color: green; font-size: 12pt;"  );
}();
