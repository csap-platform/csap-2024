...
public class CsapSecurityController {
	...
	public static void setInternalDomain( String internalDomain ) {
		CsapSecurityController.internalDomain = internalDomain;
	}

	private static String internalDomain = null ;
	...
	public String login (
		...
		if ( StringUtils.isNotEmpty( getInternalDomain() ) ) {

			if ( !getInternalDomain().contains( request.getServerName() ) ) {
				springViewModel.addAttribute( "internalDomainAvailable", getInternalDomain( ) );
			}
		}
