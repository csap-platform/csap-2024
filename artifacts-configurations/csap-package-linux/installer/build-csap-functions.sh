...
function checkOutRepos() {
	...
	print_two_columns "if this hangs" "ssl key probably needs to be added, try git clone --depth 1 git@bitbucket.org:somecompany2/demo-xxx-integration-definition "
